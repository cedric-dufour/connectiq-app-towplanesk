...
class MyViewTowplane extends MyViewGlobal {
  ...
  function prepare() {
    ...
    View.findDrawableById("unitBottomLeft").setText(Lang.format("[$1$]", [$.oMySettings.sUnitFuel]));
    ...
    View.findDrawableById("unitBottomRight").setText(Lang.format("[$1$/h]", [$.oMySettings.sUnitFuel]));
  ...
  function updateLayout() {
    ...
    // ... fuel flow
    if($.oMyProcessing.fFuelFlow != null) {
...
class MyViewTowplaneDelegate extends MyViewGlobalDelegate {
